...
public class Settings {
    ...
    //public static List<Integer> MPLS = new ArrayList<Integer>(Arrays.asList(100));

    public static List<Integer> TRANSACTION_SIZE = new ArrayList<Integer>(Arrays.asList(1, 3, 10, 40));
    //public static List<Integer> TRANSACTION_SIZE = new ArrayList<Integer>(Arrays.asList(40));
    ...
    public static int PERIOD = 20; // simulation time step in millisecond

    public static String OBSERVATION_START_DATE = "2017-11-08 00:00:00"; // the earliest timestamp of observation insert info query

    public static int TIME_SCALE_RATIO = 1440 * 5; // use this to scale 20 days to 4 minutes

    public static long SIMULATION_LENGTH = 12000; // in millisecond
